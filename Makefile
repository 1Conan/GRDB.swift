...
SQLiteCustom: SQLiteCustom/src/sqlite3.h
	...
	echo 'CUSTOM_OTHER_SWIFT_FLAGS = -D SQLITE_ENABLE_PREUPDATE_HOOK -D SQLITE_ENABLE_FTS5 -D SQLITE_ENABLE_SNAPSHOT -D SQLITE_ENABLE_JSON1' >> SQLiteCustom/GRDBCustomSQLite-USER.xcconfig
